...
export default function navbar() {
  return html`
    ...
    <nav
      class="sticky top-0 pt-4 pb-2 mb-4 md:mb-0 flex mt-12 justify-between w-full max-w-[60rem] m-auto bg-stone-200/70 backdrop-blur-sm dark:bg-stone-800 border-b border-stone-400"
    >
