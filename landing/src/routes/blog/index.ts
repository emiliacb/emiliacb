      ...
      <div class="flex flex-col space-y-3 text-pretty">
        ...
        ${raw(
          posts
            .map(
              (post) => `
          <a class="interactive group bg-yellow-300 dark:bg-blue-900 hover:bg-black hover:text-stone-100 dark:hover:bg-stone-100 dark:hover:text-stone-900" href="/${lang}/blog/${
                post.slug
              }">
